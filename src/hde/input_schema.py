...
_NOTES: Dict[str, Dict[str, Any]] = {
    ...
    "tax": {
        ...
        "hbp_withdrawal": (False, "$ withdrawn from an RRSP under the Home Buyers' Plan for a "
                                  ...
                                  "tax.renter_capital.rrsp. It JOINS the down payment on either "
                                  "financing path — state cash_available OR down_payment WITHOUT "
                                  "it; the loader adds it to whichever is stated. Like-for-like "
                                  "is cash_available + hbp_withdrawal = rent.invested_down_payment, "
                                  "or down_payment + purchase_costs + hbp_withdrawal = "
                                  "rent.invested_down_payment — the engine warns otherwise. Its "
                                  "cost is the repayment schedule alone: fixed "
