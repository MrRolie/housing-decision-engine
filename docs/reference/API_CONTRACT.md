...
| `deterministic` | per option `total_pv` + `breakdown` (keys in the glossary) + `cash_year1` / `principal_year1` (undiscounted year-1 cash and principal repaid — the cash view beside the PV view), `affordability`, `market_scenario` |
